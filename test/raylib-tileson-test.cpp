...
int main(int argc, char *argv[]) {
    ...
    {
        Map map = LoadTiled(TILESON_ROOT_DIR "/example/resources/desert.json");
    ...
    {
        int bytesRead;
        unsigned char* data = LoadFileData(TILESON_ROOT_DIR "/example/resources/desert.json", &bytesRead);
